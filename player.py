...
dummy_actions = ['Skip', 'Skip', 'Skip', 'Skip', 'Skip', 'Skip', 'Skip', 'Skip'] #Wait only
...
class GameClass:
    def __init__(self, actions_list=None, game_desc=None, level_desc=None):
        ...
        self._register_environment(gamefile, levelfile, None, 32)
        #print(self.actions)
        self._format_actions()
        #print(self.actions)
        self._create_controller()

    def _register_environment(self, domain_file, level_file, observer=None, blocksize=None):
...
class ChaserGameClass(GameClass):
    def __init__(self, actions_list=None, game_desc=None, level_desc=None):
        ...
        if game_desc is None:
            self.game = skeleton_game_race.format(immovable="", mover="", chaser=racer_str)
        else:
            self.game = game_desc
